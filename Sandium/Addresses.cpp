...
DataAddress<float> addresses::SunAngle;
...
#if _WIN32
FuncAddress<addresses::DrawHUDFuncType> addresses::DrawHUDFunc;
#endif
...
FuncAddress<addresses::DrawMenuTextEntryFuncType> addresses::DrawMenuTextEntryFunc;
...
label_client: {}
    ...
    if (*addresses::GameVersionNumber.ptr != SANDIUM_GAME_VERSION_NUMBER || *addresses::GameVersionPatchNumber.ptr != SANDIUM_GAME_VERSION_PATCH - 97)
...
#if _WIN32
    addresses::DrawHUDFunc.Register(baseAddress + 0x86000);
#endif
    ...
    addresses::DrawMenuTextEntryFunc.Register(baseAddress + DYNADDR(0x70200, 0x0));
...
label_dedicated: {}
    ...
    if (*addresses::GameVersionNumber.ptr != SANDIUM_GAME_VERSION_NUMBER || *addresses::GameVersionPatchNumber.ptr != SANDIUM_GAME_VERSION_PATCH_DEDICATED - 97)
        goto label_error;
...
#if _WIN32
    addresses::DrawHUDFunc.Register(0);
#endif
    ...
    addresses::DrawMenuTextEntryFunc.Register(0);
