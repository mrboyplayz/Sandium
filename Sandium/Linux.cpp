...
void __attribute__((constructor)) entry()
{
  ...
  {
    char text[256];
    std::snprintf(text, sizeof(char[256]), "Executable is not compatible with this Sandium version!\nAre you sure this is %d%c?", SANDIUM_GAME_VERSION_NUMBER, SANDIUM_GAME_VERSION_PATCH);
